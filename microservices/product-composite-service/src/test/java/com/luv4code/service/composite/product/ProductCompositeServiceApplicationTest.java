...
import com.luv4code.api.composite.product.RecommendationSummary;
import com.luv4code.api.composite.product.ReviewSummary;
...
import com.luv4code.service.composite.product.services.ProductCompositeIntegration;
...
class ProductCompositeServiceApplicationTest {
    ...
    void setUp() {
        when(compositeIntegration.getProduct(PRODUCT_ID_OK))
                .thenReturn(new Product(PRODUCT_ID_OK, "name", 1, "mock_address"));
